...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="dev-towns">
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Towns
                    </div>
                    <div class="card-toolbar">

                        <!--begin::Button-->
                        <button href="#" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#townsModal" @click="create()">
