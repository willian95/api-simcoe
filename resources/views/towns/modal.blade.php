<!-- Modal-->
<div class="modal fade" id="townsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="row">
               <div class="col-12">
                  <div class="form-group">
                     ...
                     <small v-if="errors.hasOwnProperty('group_id')">@{{ errors['group_id'][0] }}</small>
                  </div>
               </div>
               <div class="col-12">
                  <div class="form-group">
