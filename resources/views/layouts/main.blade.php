				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="{{ url('/') }}">
							...
							<img alt="Logo" src="{{ asset('assets/img/loginBG.jpg') }}" style="width: 100%;" />
						</a>
					</div>
					<!--end::Brand-->
					<!--begin::Aside Menu-->
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item text-center @if(strpos(url()->current(), 'airports') > -1) menu-item-active @endif" aria-haspopup="true">
									<a href="{{ route('airports.index') }}" class="menu-link text-center">
								...
								<div class="topbar-item">
									...
									<div id="user-options-menu" class="dropdown-menu" style="right: 0; float:right !important; left: unset; padding-left: 1rem; padding-bottom: 1rem;">
										<!--begin:Header-->
											...
											<a href="{{ url('/logout') }}" class="btn btn-success btn-sm font-weight-bold font-size-sm mt-2">Log out</a>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<!---	<span class="text-muted font-weight-bold mr-2">2020 - 2021©</span>-->
								<a href="h#" target="_blank" class="text-dark-75 text-hover-primary">Simcoe Copyright</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<!--end::Nav-->
